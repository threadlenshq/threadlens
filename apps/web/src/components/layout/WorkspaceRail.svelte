<script>
  ...
  let { projects = [], selectedProjectId = null, view = 'posts', collapsed = false, onToggleCollapse, onSelectProject, onRequestCreateProject, onNavigate, onboardingStatus = null, onToggleChecklist = () => {}, projectMode = 'marketing' } = $props();
