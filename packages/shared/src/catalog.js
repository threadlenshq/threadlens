export const MODEL_CATALOG = [
  ...
  { id: 'opencode-go:minimax-m2.5',         provider: 'opencode-go',  model: 'minimax-m2.5',            label: 'MiniMax M2.5 (opencode Go)',         tier: 'medium',    cost: 'subscription' },
  { id: 'opencode-go:glm-5',               provider: 'opencode-go',  model: 'glm-5',                   label: 'GLM-5 (opencode Go)',                tier: 'high',      cost: 'subscription' },
  { id: 'opencode-go:glm-5.1',             provider: 'opencode-go',  model: 'glm-5.1',                 label: 'GLM-5.1 (opencode Go)',              tier: 'reasoning', cost: 'subscription' },
  ...
  { id: 'opencode-go:qwen3.7-max',         provider: 'opencode-go',  model: 'qwen3.7-max',             label: 'Qwen 3.7 Max (opencode Go)',         tier: 'reasoning', cost: 'subscription' },
  { id: 'opencode-go:kimi-k2.5',           provider: 'opencode-go',  model: 'kimi-k2.5',               label: 'Kimi K2.5 (opencode Go)',            tier: 'high',      cost: 'subscription' },
